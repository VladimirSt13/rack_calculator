...
const handleInputChange = (target) => {
  ...
  switch (id) {
    case "floors":
      ...
      if (rackState.floors < 2) {
        ...
        refs.verticalSupport.selectedIndex = -1;
        rackState.verticalSupport = "";
      } else refs.verticalSupport.disabled = false;
      break;
    case "rows":
    ...
    case "verticalSupport":
      rackState.verticalSupport = value || "";
      break;
    case "support":
      rackState.support = value || "";
      break;
  }
  ...
  if (row) {
    ...
    if (rowData) {
      ...
      else if (tagName === "INPUT") rowData.quantity = Number(value) || null;
    }
  }
