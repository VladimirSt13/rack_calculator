...
export const BATTERY_SELECTORS = {
  ...
  form: {
    ...
    // Нові селекти для параметрів стелажа
    rows: '[data-js="battery-rows"]',
    floors: '[data-js="battery-floors"]',
    supportType: '[data-js="battery-supportType"]',
  },
  ...
  // ===== SET FEATURE (комплект стелажів) =====
  set: {
    table: '[data-js="battery-setTable"]',
    summary: '[data-js="battery-setSummary"]',
    openModalBtn: '[data-js="battery-openSetModalBtn"]',
  },
};
