// js/app/pages/battery/core/spanCalculator.js
 ...
 * 
 * Примітка: 
 * - beams = кількість балок в ряду на один проліт (мінімум 2)
 * - Балки розташовані з обох боків стелажа (2 ряди)
 * - capacity вказаний на одну балку
 * - Загальна вантажопідйомність прольоту = capacity × beams × 2 (два ряди)
 */
