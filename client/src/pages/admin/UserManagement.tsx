...
export const UserManagement: React.FC = () => {
  ...
  return (
    <AdminLayout title='Користувачі' description='Управління користувачами системи'>
              ...
              {data?.users.length === 0 ? (
                ...
                data?.users.map((user) => (
                  <TableRow key={user.id}>
                    ...
                    <TableCell>{new Date(user.createdAt).toLocaleDateString('uk-UA')}</TableCell>
          ...
          <DialogContent>
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <p className='text-sm'>{viewingUser.emailVerified ? 'Так' : 'Ні'}</p>
              </div>
              <div>
                <Label>Створено</Label>
                <p className='text-sm'>{new Date(viewingUser.createdAt).toLocaleDateString('uk-UA')}</p>
              </div>
              <div className='flex justify-end gap-2'>
        ...
        <Dialog open onOpenChange={() => setEditingUser(null)}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Змініть дані користувача та натисніть &quot;Зберегти&quot;</DialogDescription>
            </DialogHeader>
            <UserForm user={editingUser} onClose={() => setEditingUser(null)} onSuccess={handleSuccess} />
          </DialogContent>
        </Dialog>
      )}
        ...
        <Dialog open onOpenChange={setIsCreateOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Заповніть дані для створення нового користувача</DialogDescription>
            </DialogHeader>
            <UserForm onClose={() => setIsCreateOpen(false)} onSuccess={handleSuccess} />
          </DialogContent>
        </Dialog>
      )}
