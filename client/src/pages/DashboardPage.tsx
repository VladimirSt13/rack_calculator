  ...
  return (
    <div className='container mx-auto py-8 px-4'>
      ...
      <div className='mb-8'>
        ...
        <p className='text-muted-foreground'>Ласкаво просимо до системи розрахунку стелажів Акку-енерго</p>
      </div>
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-8'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground mt-1'>Збережених комплектів стелажів</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground mt-1'>У всіх комплектах</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground mt-1'>За нульовою ціною</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-8'>
        <Card>
          ...
          <CardContent>
            <p className='text-sm text-muted-foreground mb-4'>Розрахунок стелажів для довільних розмірів</p>
            <Button onClick={() => navigate('/rack')} className='w-full'>
              Розрахувати
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className='text-sm text-muted-foreground mb-4'>Автоматичний підбір стелажа для акумуляторів</p>
            <Button onClick={() => navigate('/battery')} className='w-full' variant='outline'>
              Підібрати
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className='text-sm text-muted-foreground mb-4'>Перегляд та управління збереженими комплектами</p>
            <Button onClick={() => navigate('/my-sets')} className='w-full' variant='outline'>
              Переглянути
            </Button>
          </CardContent>
        </Card>
      ...
      {recentSets.length > 0 && (
        <Card>
          ...
          <CardContent>
              ...
              {recentSets.map((set) => (
                ...
                >
                  ...
                  <div className='flex items-center gap-4'>
                    ...
                    <Button variant='outline' size='sm' onClick={() => setViewingSet(set)}>
            ...
            <div className='mt-4'>
              <Button variant='outline' onClick={() => navigate('/my-sets')} className='w-full'>
