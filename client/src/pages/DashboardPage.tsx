...
const DashboardPage: React.FC = () => {
  ...
  const mySets =
    setsData?.rackSets?.filter((set) => set.user_id === user?.id) || [];
  ...
  const stats = {
    ...
    totalRacks: mySets.reduce(
      (sum, set) =>
        sum + (set.racks?.reduce((s, r) => s + (r.quantity || 1), 0) || 0),
      0,
    ),
    totalCost: mySets.reduce(
      (sum, set) => sum + (set.total_cost_snapshot || set.total_cost || 0),
      0,
    ),
  };
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-lg font-bold text-primary">
                      {(set.total_cost_snapshot || set.total_cost || 0).toFixed(
                        2,
                      )}{" "}
                      ₴
                    </span>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-primary">
                    {(
                      viewingSet.total_cost_snapshot ||
                      viewingSet.total_cost ||
                      0
                    ).toFixed(2)}{" "}
                    ₴
                  </p>
