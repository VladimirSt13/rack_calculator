 ...
 */
export interface FieldRowInputProps extends React.InputHTMLAttributes<HTMLInputElement> {
 ...
 */
export interface FieldRowSelectProps extends React.SelectHTMLAttributes<HTMLSelectElement> {
...
export const FieldRowValue: React.FC<FieldRowValueProps> = ({
  ...
  return (
    <span
      className={cn("text-sm", mono && "font-mono", "px-2 py-1", className)}
      {...props}
    />
  );
};
