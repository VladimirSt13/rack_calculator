...
import type { RackSetForm } from '../useRackSetModal';
...
interface RackSetModalContentProps {
  isOpen: boolean;
  onClose: () => void;
  form: {
    register: (name: string, options?: any) => any;
    handleSubmit: (onSubmit: (data: RackSetForm) => void) => (e?: React.BaseSyntheticEvent) => void;
    formState: { errors: Record<string, { message?: string }> };
    getValues: () => RackSetForm;
  };
...
export const RackSetModalContent: React.FC<RackSetModalContentProps> = ({
  isOpen,
  onClose,
  form,
  includePrices,
...
export default RackSetModalContent;