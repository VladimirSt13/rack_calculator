  ...
  try {
    ...
    try {
      ...
      if (usersWithTokens.length > 0) {
        console.log(
          `[Migration 016] Found ${usersWithTokens.length} users with verification tokens`,
        );
      }
      ...
      console.log(
        "[Migration 016] verification_token field does not exist or already removed",
      );
    }
    ...
    try {
      ...
      if (hasRacksField) {
        ...
        console.log(
          "[Migration 016] racks field does not exist (already removed)",
        );
      }
    } catch (e) {
    ...
    try {
      ...
      console.log(
        `[Migration 016] Removed ${result.changes} old audit log entries`,
      );
    } catch (e) {
    ...
    try {
      ...
      console.log(
        `[Migration 016] Removed ${result.changes} expired/revoked refresh tokens`,
      );
    } catch (e) {
    ...
    try {
      ...
      console.log(
        `[Migration 016] Removed ${result.changes} used/expired email verifications`,
      );
    } catch (e) {
      console.log(
        "[Migration 016] Error cleaning email verifications:",
        e.message,
      );
    }
    ...
    try {
      ...
      console.log(
        `[Migration 016] Removed ${result.changes} expired password reset tokens`,
      );
    } catch (e) {
      console.log(
        "[Migration 016] Error cleaning password reset tokens:",
        e.message,
      );
    }
...
export const down = (db) => {
  console.log(
    "[Migration 016] Rollback is not possible - data has been permanently deleted",
  );
  ...
  try {
    ...
    console.log(
      "[Migration 016] Could not add verification_token back:",
      e.message,
    );
  }
};
