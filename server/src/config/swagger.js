...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '2.0.0',
      description: 'API для калькулятора стелажів та підбору акумуляторів для компанії "Акку-енерго"',
      contact: {
        name: 'Акку-енерго',
      ...
      schemas: {
        ...
        User: {
          ...
          properties: {
            ...
            email: { type: 'string', format: 'email', example: 'user@accu-energo.com.ua' },
          ...
          properties: {
            ...
            permissions: { 
              ...
              properties: {
                price_types: {
                  type: 'array',
                  items: { type: 'string', enum: ['базова', 'без_ізоляторів', 'нульова', 'собівартість', 'оптова'] },
                },
              },
            },
          },
        ...
        RackCalculationRequest: {
          ...
          properties: {
            ...
            beamsPerRow: { type: 'integer', minimum: 1, maximum: 20, example: 2 },
            supports: { type: 'string', example: 'C', description: 'Тип опори' },
            verticalSupports: { type: 'string', example: 'V', description: 'Тип вертикальної опори' },
            spans: {
              type: 'array',
              items: {
                type: 'object',
                properties: {
                  item: { type: 'string', example: '3000', description: 'Довжина прольоту в мм' },
          ...
          properties: {
            ...
            prices: {
              ...
              items: {
                type: 'object',
                properties: {
                  type: { type: 'string', enum: ['базова', 'без_ізоляторів', 'нульова'] },
                  value: { type: 'number', example: 1500.00 },
                  label: { type: 'string', example: 'Базова ціна' },
                },
              },
            },
            totalCost: { type: 'number', example: 1500.00 },
        ...
        BatteryCalculationRequest: {
          ...
          properties: {
            batteryDimensions: {
              ...
              properties: {
                length: { type: 'number', example: 407, description: 'Довжина в мм' },
                width: { type: 'number', example: 176, description: 'Ширина в мм' },
                height: { type: 'number', example: 240, description: 'Висота в мм' },
                weight: { type: 'number', example: 30, description: 'Вага в кг' },
              },
            },
            quantity: { type: 'integer', minimum: 1, example: 24 },
            format: { type: 'string', example: 'L', description: 'Бажаний формат розміщення' },
          },
        },
        BatteryVariant: {
          type: 'object',
          properties: {
            ...
            totalCost: { type: 'number', example: 2500.00 },
          },
        },
        ...
        RackSet: {
          ...
          properties: {
            ...
            description: { type: 'string', example: 'Стелажі для зберігання акумуляторів' },
            racks: {
              type: 'array',
              items: { $ref: '#/components/schemas/BatteryVariant' },
            },
            totalCost: { type: 'number', example: 15000.00 },
            createdAt: { type: 'string', format: 'date-time' },
            updatedAt: { type: 'string', format: 'date-time' },
          },
        },
        ...
        AuditLog: {
          ...
          properties: {
            ...
            userEmail: { type: 'string', nullable: true, example: 'user@accu-energo.com.ua' },
            action: { type: 'string', enum: ['CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'PASSWORD_CHANGE'], example: 'LOGIN' },
