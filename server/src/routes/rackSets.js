...
router.delete(
  ...
  authenticate,
  authorizeRole(["admin"]),
  rackSetController.hardDeleteRackSet,
);
...
router.post(
  "/:id/revision",
  authenticate,
  rackSetController.createRackSetRevision,
);
...
router.get(
  "/:id/revisions",
  authenticate,
  rackSetController.getRackSetRevisions,
);
...
router.post(
  ...
  authenticate,
  authorizeRole(["admin"]),
  rackSetController.cleanupDeletedRackSets,
);
