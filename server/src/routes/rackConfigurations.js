 ...
 */
router.post('/find-or-create', authenticate, rackConfigurationController.findOrCreateConfiguration);

/**
 * GET /api/rack-configurations/:id
 * Отримати конфігурацію за ID
 */
router.get('/:id', authenticate, rackConfigurationController.getConfigurationById);

/**
 * POST /api/rack-configurations/:id/calculate-prices
 * Розрахувати ціни для конфігурації
 */
router.post('/:id/calculate-prices', authenticate, rackConfigurationController.calculatePricesForConfiguration);
